    ...
    <div class="col-md-10 col-sm-9">
        <div class="panel row">
            <div class="panel-heading">
                <a href="{{ route('admin.permission.index') }}" class="disabled"><strong> 权限管理 </strong></a> &nbsp;
                <a href="{{ route('admin.permission.create') }}" class=""><strong> 新增权限</strong></a> &nbsp;
            </div>
        </div><!--toolBar start-->
        <!-- 列表开始 -->
                    ...
                    @foreach($data as $permission)
                        <tr id="tr_{{ $permission->id }}">
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.permission.getCreate',$permission->id) }}">新增子权限</a>&nbsp;
                                <a href="{{ route('admin.permission.edit',$permission->id) }}">修改</a>&nbsp;
