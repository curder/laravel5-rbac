    ...
    <div class="col-md-10 col-sm-9">
        <div class="panel row">
            <div class="panel-heading">
                <a href="{{ route('admin.role.index') }}" class="disabled"><strong> 角色管理 </strong></a> &nbsp;
                <a href="{{ route('admin.role.create') }}" class=""><strong> 新增角色</strong></a> &nbsp;
            </div>
        </div><!--toolBar start-->
        <!-- 列表开始 -->
                    ...
                    @foreach($data as $role)
                        <tr id="tr_{{ $role->id }}">
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.role.edit',$role->id) }}">修改</a>&nbsp;
                                <a href="{{ route('admin.role.show',$role->id) }}" > 授权</a>&nbsp;
